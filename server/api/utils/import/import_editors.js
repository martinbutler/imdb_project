...
var outputFile = './importFiles/editors.json';

var instream = fs.createReadStream('../../../stage/editors.list', {encoding: 'binary'});
  ...
  if (atData) {
    ...
    if (line.length > 0) {
      ...
      if (line.substring(0, 4) === '----') {
        ...
        // check if line is includes editors name
        if (parseArray[0] !== '') {
...
// mongoimport --db imdbproject-dev --collection editors --file editors.json
