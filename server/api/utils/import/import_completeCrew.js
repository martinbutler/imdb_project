...
var outputFile = './importFiles/completeCrew.json';

var instream = fs.createReadStream('../../../stage/complete-crew.list', {encoding: 'binary'});
...
rl.on('line', function(line) {
  ...
  } else if(line === "CREW COVERAGE TRACKING LIST") {
    atTitle = true;
...
// mongoimport --db imdbproject-dev --collection completecrew --file completeCrew.json
