...
var outputFile = './importFiles/costumeDesigners.json';

var instream = fs.createReadStream('../../../stage/costume-designers.list', {encoding: 'binary'});
...
rl.on('line', function(line) {
  if (atData) {
    ...
    if (line.length > 0) {
      ...
      if (line.substring(0, 4) === '----') {
        ...
        // check if line is includes costumeDesigners name
        if (parseArray[0] !== '') {
  ...
  } else if(line === "THE COSTUME DESIGNERS LIST") {
    atTitle = true;
