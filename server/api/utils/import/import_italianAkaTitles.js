...
var outputFile = './importFiles/italianAkaTitles.json';

var instream = fs.createReadStream('../../../stage/italian-aka-titles.list', {encoding: 'binary'});
...
rl.on('line', function(line) {
  ...
  } else if(line === "AKA TITLES LIST ITALIAN") {
    atTitle = true;
...
// mongoimport --db imdbproject-dev --collection italianAkaTitles --file italianAkaTitles.json
