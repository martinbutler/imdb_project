...
var outputFile = './importFiles/distributors.json';

var instream = fs.createReadStream('../../../stage/distributors.list', {encoding: 'binary'});
...
rl.on('line', function(line) {
  ...
  } else if(line === "DISTRIBUTORS LIST") {
    atTitle = true;
...
// mongoimport --db imdbproject-dev --collection distributors --file distributors.json
