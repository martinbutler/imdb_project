...
var outputFile = './importFiles/isoAkaTitles.json';

var instream = fs.createReadStream('../../../stage/iso-aka-titles.list', {encoding: 'binary'});
...
rl.on('line', function(line) {
  ...
  } else if(line === "AKA TITLES LIST ISO") {
    atTitle = true;
