...
var outputFile = './importFiles/akaTitles.json';

var instream = fs.createReadStream('../../../stage/aka-titles.list', {encoding: 'binary'});
...
// mongoimport --db imdbproject-dev --collection akaTitles --file akaTitles.json
